...
set GCC4ARM_VERSION=gcc-arm-none-eabi-6-2017-q2
set GCC4ARM_FILENAME=gcc-arm-none-eabi-6-2017-q2-update-win32.zip
set GCC4ARM_URL=https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu-rm/6-2017q2/%GCC4ARM_FILENAME%
set GCC4ARM_TAR=%ROOTDIR%%GCC4ARM_FILENAME%
set GCC4ARM_MD5=df6c2f763a6114c951e3f1e509af3cbc
...
call :RunAndLog %OUR_MAKE% -C samples/ clean-all
if errorlevel 1 goto ExitOnError

...
ifeq "$(SMOOTHIEWARE_FEATURE_ENABLE)" "1"
...
MAIN_DEFINES += -DSMOOTHIEWARE_FEATURE_ENABLE=$(SMOOTHIEWARE_FEATURE_ENABLE)
endif
...
# mbed library locations depend on build type.
ifeq "$(GCC4MBED_TYPE)" "Debug"
MBED_LIBRARY_SRC := $(DEBUG_DIR)/$(MBED_LIB_NAME).a
endif
ifeq "$(GCC4MBED_TYPE)" "Develop"
MBED_LIBRARY_SRC := $(DEVELOP_DIR)/$(MBED_LIB_NAME).a
endif
ifeq "$(GCC4MBED_TYPE)" "Release"
MBED_LIBRARY_SRC := $(RELEASE_DIR)/$(MBED_LIB_NAME).a
endif

MBED_LIBRARY_TARGET  := $(MBED_DROP_DIR)/$(MBED_LIB_NAME).a
